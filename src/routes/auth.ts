...
import { register, login, logout, getProfile, changePassword, forgotPassword, resetPassword } from '../controllers/auth';
 ...
 *               $ref: '#/components/schemas/Error'
 */
router.put('/change-password', authenticate, validate(Joi.object({
